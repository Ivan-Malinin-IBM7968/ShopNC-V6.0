...
--
-- 表的结构 `shopnc_activity`
--

CREATE TABLE IF NOT EXISTS `shopnc_activity` (
...
--
-- 表的结构 `shopnc_activity_detail`
--

CREATE TABLE IF NOT EXISTS `shopnc_activity_detail` (
...
--
-- 导出表中的数据 `shopnc_activity_detail`
--
...
CREATE TABLE IF NOT EXISTS `shopnc_address` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='买家地址信息表' AUTO_INCREMENT=2 ;

--
-- 导出表中的数据 `shopnc_address`
--

INSERT INTO `shopnc_address` (`address_id`, `member_id`, `true_name`, `area_id`, `city_id`, `area_info`, `address`, `tel_phone`, `mob_phone`, `is_default`) VALUES
(1, 2, '测试', 37, 36, '北京	北京市	东城区', '纬地路', '', '13020111648', '0');
...
CREATE TABLE IF NOT EXISTS `shopnc_admin` (
...
INSERT INTO `shopnc_admin` (`admin_id`, `admin_name`, `admin_password`, `admin_login_time`, `admin_login_num`, `admin_is_super`, `admin_gid`) VALUES
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1421572907, 1, 1, 0);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_admin_log`
--

CREATE TABLE IF NOT EXISTS `shopnc_admin_log` (
...
CREATE TABLE IF NOT EXISTS `shopnc_adv` (
  ...
  PRIMARY KEY (`adv_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='广告表' AUTO_INCREMENT=16 ;
...
--
-- 表的结构 `shopnc_adv_click`
--

CREATE TABLE IF NOT EXISTS `shopnc_adv_click` (
...
--
-- 表的结构 `shopnc_adv_position`
--

CREATE TABLE IF NOT EXISTS `shopnc_adv_position` (
  ...
  PRIMARY KEY (`ap_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='广告位表' AUTO_INCREMENT=373 ;

--
-- 导出表中的数据 `shopnc_adv_position`
--
...
(9, '首页底部通栏图片广告', '位于首页底部的通栏型图片广告', 0, 2, 1, 1200, 80, 100, 1, 0, '04418235791378401.jpg'),
...
(372, '买家中心页右侧广告位', '买家中心页右侧广告位', 0, 1, 1, 200, 350, 100, 0, 0, 'adv200-300.gif');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_album_class`
--
...
--
-- 导出表中的数据 `shopnc_album_class`
--

INSERT INTO `shopnc_album_class` (`aclass_id`, `aclass_name`, `store_id`, `aclass_des`, `aclass_sort`, `aclass_cover`, `upload_time`, `is_default`) VALUES
(1, '默认相册', 1, '', 255, '', 1387942806, 1);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_album_pic`
--
...
CREATE TABLE IF NOT EXISTS `shopnc_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='相册图片表' AUTO_INCREMENT=918 ;

--
-- 导出表中的数据 `shopnc_album_pic`
--

INSERT INTO `shopnc_album_pic` (`apic_id`, `apic_name`, `apic_tag`, `aclass_id`, `apic_cover`, `apic_size`, `apic_spec`, `store_id`, `upload_time`) VALUES
(388, '11', '', 1, '1_04418206625430066.jpg', 174541, '1x1', 1, 1388476662),
...
CREATE TABLE IF NOT EXISTS `shopnc_article` (
...
INSERT INTO `shopnc_article` (`article_id`, `ac_id`, `article_url`, `article_show`, `article_sort`, `article_title`, `article_content`, `article_time`) VALUES
(6, 2, '', 1, 255, '如何注册成为会员', '如何注册成为会员', 1389864697),
...
CREATE TABLE IF NOT EXISTS `shopnc_article_class` (
...
INSERT INTO `shopnc_article_class` (`ac_id`, `ac_code`, `ac_name`, `ac_parent_id`, `ac_sort`) VALUES
(1, 'notice', '商城公告', 0, 255),
(2, 'member', '帮助中心', 0, 255),
(3, 'store', '店主之家', 0, 255),
...
--
-- 表的结构 `shopnc_attribute`
--

CREATE TABLE IF NOT EXISTS `shopnc_attribute` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品属性表' AUTO_INCREMENT=221 ;

--
-- 导出表中的数据 `shopnc_attribute`
--

INSERT INTO `shopnc_attribute` (`attr_id`, `attr_name`, `type_id`, `attr_value`, `attr_show`, `attr_sort`) VALUES
...
--
-- 表的结构 `shopnc_attribute_value`
--

CREATE TABLE IF NOT EXISTS `shopnc_attribute_value` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品属性值表' AUTO_INCREMENT=3181 ;

--
-- 导出表中的数据 `shopnc_attribute_value`
--

INSERT INTO `shopnc_attribute_value` (`attr_value_id`, `attr_value_name`, `attr_id`, `type_id`, `attr_value_sort`) VALUES
(3050, '毛衣', 206, 34, 0),
(3051, '开衫', 206, 34, 0),
(3052, '套头衫', 206, 34, 0),
(3053, '打底衫', 206, 34, 0),
...
CREATE TABLE IF NOT EXISTS `shopnc_brand` (
...
INSERT INTO `shopnc_brand` (`brand_id`, `brand_name`, `brand_class`, `brand_pic`, `brand_sort`, `brand_recommend`, `store_id`, `brand_apply`, `class_id`) VALUES
(79, 'justyle', '服饰鞋帽', '04397468710494742_sm.jpg', 0, 0, 0, 1, 1),
...
(183, 'TP-LINK', '数码办公', '04398156873572761_sm.jpg', 0, 1, 0, 1, 256),
...
(285, '雀巢', '母婴用品', '04399881950170970_sm.jpg', 0, 0, 0, 1, 959),
...
CREATE TABLE IF NOT EXISTS `shopnc_cart` (
...
CREATE TABLE IF NOT EXISTS `shopnc_circle` (
...
--
-- 表的结构 `shopnc_circle_affix`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_affix` (
...
--
-- 表的结构 `shopnc_circle_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_class` (
...
--
-- 表的结构 `shopnc_circle_explog`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_explog` (
...
--
-- 表的结构 `shopnc_circle_expmember`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_expmember` (
...
--
-- 导出表中的数据 `shopnc_circle_expmember`
--
...
--
-- 表的结构 `shopnc_circle_exptheme`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_exptheme` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
--
-- 导出表中的数据 `shopnc_circle_exptheme`
--
...
--
-- 表的结构 `shopnc_circle_fs`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_fs` (
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
--
-- 表的结构 `shopnc_circle_inform`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_inform` (
...
--
-- 表的结构 `shopnc_circle_like`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id'
...
--
-- 表的结构 `shopnc_circle_mapply`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_mapply` (
...
--
-- 表的结构 `shopnc_circle_member`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_member` (
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
  `circle_name` varchar(12) NOT NULL COMMENT '圈子名称',
  `member_name` varchar(50) NOT NULL COMMENT '会员名称',
...
--
-- 表的结构 `shopnc_circle_ml`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_ml` (
  `circle_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '圈子id',
...
--
-- 表的结构 `shopnc_circle_mldefault`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_mldefault` (
...
--
-- 导出表中的数据 `shopnc_circle_mldefault`
--

INSERT INTO `shopnc_circle_mldefault` (`mld_id`, `mld_name`, `mld_exp`) VALUES
(1, '初级粉丝', 1),
(2, '中级粉丝', 5),
(3, '高级粉丝', 15),
(4, '正式会员', 30),
...
--
-- 表的结构 `shopnc_circle_mlref`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_mlref` (
...
--
-- 导出表中的数据 `shopnc_circle_mlref`
--

INSERT INTO `shopnc_circle_mlref` (`mlref_id`, `mlref_name`, `mlref_addtime`, `mlref_status`, `mlref_1`, `mlref_2`, `mlref_3`, `mlref_4`, `mlref_5`, `mlref_6`, `mlref_7`, `mlref_8`, `mlref_9`, `mlref_10`, `mlref_11`, `mlref_12`, `mlref_13`, `mlref_14`, `mlref_15`, `mlref_16`) VALUES
...
--
-- 表的结构 `shopnc_circle_recycle`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_recycle` (
...
--
-- 表的结构 `shopnc_circle_thclass`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_thclass` (
...
--
-- 表的结构 `shopnc_circle_theme`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_theme` (
...
--
-- 表的结构 `shopnc_circle_thg`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_thg` (
...
--
-- 表的结构 `shopnc_circle_thpoll`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_thpoll` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
...
--
-- 表的结构 `shopnc_circle_thpolloption`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_thpolloption` (
...
--
-- 导出表中的数据 `shopnc_circle_thpolloption`
--
...
--
-- 表的结构 `shopnc_circle_thpollvoter`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
...
--
-- 导出表中的数据 `shopnc_circle_thpollvoter`
--
...
--
-- 表的结构 `shopnc_circle_threply`
--

CREATE TABLE IF NOT EXISTS `shopnc_circle_threply` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
--
-- 表的结构 `shopnc_cms_article`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_article` (
...
--
-- 表的结构 `shopnc_cms_article_attitude`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_article_attitude` (
...
--
-- 导出表中的数据 `shopnc_cms_article_attitude`
--
...
--
-- 表的结构 `shopnc_cms_article_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_article_class` (
...
--
-- 导出表中的数据 `shopnc_cms_article_class`
--
...
--
-- 表的结构 `shopnc_cms_comment`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_comment` (
...
--
-- 表的结构 `shopnc_cms_comment_up`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_comment_up` (
...
--
-- 表的结构 `shopnc_cms_index_module`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_index_module` (
...
--
-- 导出表中的数据 `shopnc_cms_index_module`
--
...
--
-- 表的结构 `shopnc_cms_module`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_module` (
...
--
-- 导出表中的数据 `shopnc_cms_module`
--

INSERT INTO `shopnc_cms_module` (`module_id`, `module_title`, `module_name`, `module_type`, `module_class`) VALUES
...
--
-- 表的结构 `shopnc_cms_module_assembly`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_module_assembly` (
...
--
-- 导出表中的数据 `shopnc_cms_module_assembly`
--

INSERT INTO `shopnc_cms_module_assembly` (`assembly_id`, `assembly_title`, `assembly_name`, `assembly_explain`) VALUES
(1, '文章', 'article', '文章组件'),
(2, '图片', 'picture', '图片组件'),
(3, '商品', 'goods', '商品组件'),
(4, '品牌', 'brand', '品牌组件'),
...
--
-- 表的结构 `shopnc_cms_module_frame`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_module_frame` (
...
--
-- 导出表中的数据 `shopnc_cms_module_frame`
--

INSERT INTO `shopnc_cms_module_frame` (`frame_id`, `frame_title`, `frame_name`, `frame_explain`, `frame_structure`) VALUES
...
--
-- 表的结构 `shopnc_cms_navigation`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_navigation` (
...
--
-- 导出表中的数据 `shopnc_cms_navigation`
--

INSERT INTO `shopnc_cms_navigation` (`navigation_id`, `navigation_title`, `navigation_link`, `navigation_sort`, `navigation_open_type`) VALUES
(1, '商城', 'http://localhost/tjshop/', 255, 1),
(2, '圈子', 'http://localhost/tjshop/circle', 255, 1),
(3, '微商城', 'http://localhost/tjshop/microshop', 255, 1),
(4, '品牌', 'http://localhost/tjshop/shop/index.php?act=brand', 255, 1);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_cms_picture`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_picture` (
...
--
-- 表的结构 `shopnc_cms_picture_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_picture_class` (
  `class_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(1) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`class_id`)
...
--
-- 导出表中的数据 `shopnc_cms_picture_class`
--
...
--
-- 表的结构 `shopnc_cms_picture_image`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_picture_image` (
...
--
-- 导出表中的数据 `shopnc_cms_picture_image`
--
...
--
-- 表的结构 `shopnc_cms_special`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_special` (
...
CREATE TABLE IF NOT EXISTS `shopnc_cms_tag` (
...
--
-- 表的结构 `shopnc_cms_tag_relation`
--

CREATE TABLE IF NOT EXISTS `shopnc_cms_tag_relation` (
...
--
-- 导出表中的数据 `shopnc_cms_tag_relation`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='投诉商品表' AUTO_INCREMENT=1 ;

--
-- 导出表中的数据 `shopnc_complain_goods`
--
...
--
-- 导出表中的数据 `shopnc_complain_subject`
--

INSERT INTO `shopnc_complain_subject` (`complain_subject_id`, `complain_subject_content`, `complain_subject_desc`, `complain_subject_state`) VALUES
...
CREATE TABLE IF NOT EXISTS `shopnc_consult` (
...
CREATE TABLE IF NOT EXISTS `shopnc_cron` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='任务队列表' AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `shopnc_daddress`
--

CREATE TABLE IF NOT EXISTS `shopnc_daddress` (
  `address_id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址ID',
...
--
-- 表的结构 `shopnc_document`
--

CREATE TABLE IF NOT EXISTS `shopnc_document` (
...
--
-- 导出表中的数据 `shopnc_document`
--

INSERT INTO `shopnc_document` (`doc_id`, `doc_code`, `doc_title`, `doc_content`, `doc_time`) VALUES
...
--
-- 表的结构 `shopnc_evaluate_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_evaluate_goods` (
...
--
-- 表的结构 `shopnc_evaluate_store`
--

CREATE TABLE IF NOT EXISTS `shopnc_evaluate_store` (
...
CREATE TABLE IF NOT EXISTS `shopnc_express` (
...
--
-- 导出表中的数据 `shopnc_express`
--

INSERT INTO `shopnc_express` (`id`, `e_name`, `e_state`, `e_code`, `e_letter`, `e_order`, `e_url`) VALUES
...
--
-- 表的结构 `shopnc_favorites`
--

CREATE TABLE IF NOT EXISTS `shopnc_favorites` (
...
--
-- 表的结构 `shopnc_flowstat_1`
--

CREATE TABLE IF NOT EXISTS `shopnc_flowstat_1` (
...
--
-- 导出表中的数据 `shopnc_flowstat_1`
--

INSERT INTO `shopnc_flowstat_1` (`date`, `clicknum`, `store_id`, `type`, `goods_id`) VALUES
(20150103, 1, 1, 'sum', 0),
(20150103, 1, 1, 'goods', 231),
(20150118, 4, 1, 'sum', 0),
(20150118, 1, 1, 'goods', 231),
(20150118, 3, 1, 'goods', 233);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_flowstat_2`
--

CREATE TABLE IF NOT EXISTS `shopnc_flowstat_2` (
  `date` int(8) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
--
-- 表的结构 `shopnc_flowstat_3`
--

CREATE TABLE IF NOT EXISTS `shopnc_flowstat_3` (
  `date` int(8) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
--
-- 表的结构 `shopnc_flowstat_4`
--

CREATE TABLE IF NOT EXISTS `shopnc_flowstat_4` (
  `date` int(8) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
--
-- 表的结构 `shopnc_flowstat_5`
--

CREATE TABLE IF NOT EXISTS `shopnc_flowstat_5` (
  `date` int(8) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
CREATE TABLE IF NOT EXISTS `shopnc_gadmin` (
...
CREATE TABLE IF NOT EXISTS `shopnc_goods` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品表' AUTO_INCREMENT=234 ;
...
(38, 100008, '正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 蓝色', '新款特惠', 1, '官方店铺', 14, 103, 189.00, 702.00, '', 0, 0, 0, 'a:1:{i:222;s:6:"蓝色";}', 56, '1_04418207207476705.jpg', 1, 1, 1388476693, 1388476693, 1, 36, 222, 0, 0.00, 0, 1, ',0,', 5, 0),
...
(232, 100086, '中华老字号 东阿阿胶桃花姬阿胶糕300g', '', 1, '官方店铺', 617, 250, 0.02, 168.00, '', 2, 2, 0, 'N;', 41, '1_04423411880302392.png', 1, 1, 1388997235, 1421572982, 1, 36, 0, 0, 0.00, 0, 1, ',0,', 5, 0),
(233, 100085, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒', '全国唯一支持开瓶试饮7天无理由退换货', 1, '官方店铺', 630, 263, 0.02, 1688.00, '', 0, 3, 0, 'N;', 97, '1_04423392298369303.jpg', 1, 1, 1421573349, 1421573452, 1, 36, 0, 0, 0.00, 0, 1, ',0,', 5, 0);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_goods_attr_index`
--

CREATE TABLE IF NOT EXISTS `shopnc_goods_attr_index` (
...
--
-- 导出表中的数据 `shopnc_goods_attr_index`
--

INSERT INTO `shopnc_goods_attr_index` (`goods_id`, `goods_commonid`, `gc_id`, `type_id`, `attr_id`, `attr_value_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `shopnc_goods_class` (
...
INSERT INTO `shopnc_goods_class` (`gc_id`, `gc_name`, `type_id`, `type_name`, `gc_parent_id`, `gc_sort`, `gc_title`, `gc_keywords`, `gc_description`) VALUES
(1, '服饰鞋帽', 0, '', 0, 255, '', '', ''),
(2, '礼品箱包', 0, '', 0, 255, '', '', ''),
(3, '家居家装', 0, '', 0, 255, '', '', ''),
(4, '女装', 0, '', 1, 255, '', '', ''),
...
--
-- 表的结构 `shopnc_goods_class_staple`
--

CREATE TABLE IF NOT EXISTS `shopnc_goods_class_staple` (
...
--
-- 导出表中的数据 `shopnc_goods_class_staple`
--
...
--
-- 表的结构 `shopnc_goods_class_tag`
--

CREATE TABLE IF NOT EXISTS `shopnc_goods_class_tag` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品分类TAG表' AUTO_INCREMENT=900 ;

--
-- 导出表中的数据 `shopnc_goods_class_tag`
--

INSERT INTO `shopnc_goods_class_tag` (`gc_tag_id`, `gc_id_1`, `gc_id_2`, `gc_id_3`, `gc_tag_name`, `gc_tag_value`, `gc_id`, `type_id`) VALUES
...
--
-- 表的结构 `shopnc_goods_common`
--

CREATE TABLE IF NOT EXISTS `shopnc_goods_common` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品公共内容表' AUTO_INCREMENT=100087 ;

--
-- 导出表中的数据 `shopnc_goods_common`
--
...
(100085, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒', '全国唯一支持开瓶试饮7天无理由退换货', 630, '食品饮料 &gt;中外名酒 &gt;葡萄酒', 1, '官方店铺', 'N;', 'N;', 263, '长城葡萄酒', 50, '1_04423392298369303.jpg', 'N;', '<img src="../data/upload/shop/store/goods/1/1_04423392645620711_1280.jpg" alt="image" />', 1, NULL, 1, '', 0, 1388995274, 0, '', 0.02, 1688.00, 0.00, 0, '', 0, '', 1, 0.00, 0, 1, 36, ',0,', 0, 0),
(100086, '中华老字号 东阿阿胶桃花姬阿胶糕300g', '', 617, '食品饮料 &gt;休闲食品 &gt;坚果炒货', 1, '官方店铺', 'N;', 'N;', 250, '养生堂', 50, '1_04423411880302392.png', 'N;', '<img src="../data/upload/shop/store/goods/1/1_04423412221350722_1280.jpg" alt="image" />', 1, NULL, 1, '', 0, 1388997235, 0, '', 0.02, 168.00, 0.00, 0, '', 0, '', 1, 0.00, 0, 1, 36, ',0,', 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_goods_images`
--

CREATE TABLE IF NOT EXISTS `shopnc_goods_images` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品图片' AUTO_INCREMENT=606 ;

--
-- 导出表中的数据 `shopnc_goods_images`
--

INSERT INTO `shopnc_goods_images` (`goods_image_id`, `goods_commonid`, `store_id`, `color_id`, `goods_image`, `goods_image_sort`, `is_default`) VALUES
(11, 1, 2, 218, '2_04415409366497470.jpg', 0, 1),
...
--
-- 表的结构 `shopnc_groupbuy`
--

CREATE TABLE IF NOT EXISTS `shopnc_groupbuy` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='团购商品表' AUTO_INCREMENT=4 ;

--
-- 导出表中的数据 `shopnc_groupbuy`
--

INSERT INTO `shopnc_groupbuy` (`groupbuy_id`, `groupbuy_name`, `start_time`, `end_time`, `goods_id`, `goods_commonid`, `goods_name`, `store_id`, `store_name`, `goods_price`, `groupbuy_price`, `groupbuy_rebate`, `virtual_quantity`, `upper_limit`, `buyer_count`, `buy_quantity`, `groupbuy_intro`, `state`, `recommended`, `views`, `class_id`, `area_id`, `groupbuy_image`, `groupbuy_image1`, `remark`) VALUES
(2, '228元任选一箱，国际大赛权威推荐“金奖”葡萄酒！', 1388995740, 1414684800, 231, 100085, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口', 1, '官方店铺', 899.00, 228.00, 2.54, 0, 5, 0, 0, '<img src="../data/upload/shop/store/goods/1/1_04423392645620711_1280.jpg" alt="image" />', 20, 1, 21, 0, 0, '1_04423393922882448.jpg', '1_04423395187054760.jpg', '全国唯一支持开瓶试饮7天无理由退换货'),
...
--
-- 表的结构 `shopnc_groupbuy_area`
--

CREATE TABLE IF NOT EXISTS `shopnc_groupbuy_area` (
  ...
  PRIMARY KEY (`area_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='团购地区表' AUTO_INCREMENT=1 ;

--
-- 导出表中的数据 `shopnc_groupbuy_area`
--
...
--
-- 表的结构 `shopnc_groupbuy_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_groupbuy_class` (
  ...
  PRIMARY KEY (`class_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='团购类别表' AUTO_INCREMENT=1 ;

--
-- 导出表中的数据 `shopnc_groupbuy_class`
--
...
--
-- 表的结构 `shopnc_groupbuy_price_range`
--

CREATE TABLE IF NOT EXISTS `shopnc_groupbuy_price_range` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='团购价格区间表' AUTO_INCREMENT=1 ;

--
-- 导出表中的数据 `shopnc_groupbuy_price_range`
--
...
--
-- 表的结构 `shopnc_groupbuy_quota`
--

CREATE TABLE IF NOT EXISTS `shopnc_groupbuy_quota` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='团购套餐表' AUTO_INCREMENT=6 ;

--
-- 导出表中的数据 `shopnc_groupbuy_quota`
--

INSERT INTO `shopnc_groupbuy_quota` (`quota_id`, `member_id`, `store_id`, `member_name`, `store_name`, `start_time`, `end_time`) VALUES
(5, 1, 1, 'shopnc', '官方店铺', 1388995313, 1414915313);
...
--
-- 导出表中的数据 `shopnc_inform_subject`
--

INSERT INTO `shopnc_inform_subject` (`inform_subject_id`, `inform_subject_content`, `inform_subject_type_id`, `inform_subject_type_name`, `inform_subject_state`) VALUES
...
--
-- 表的结构 `shopnc_inform_subject_type`
--
...
--
-- 导出表中的数据 `shopnc_inform_subject_type`
--

INSERT INTO `shopnc_inform_subject_type` (`inform_type_id`, `inform_type_name`, `inform_type_desc`, `inform_type_state`) VALUES
...
CREATE TABLE IF NOT EXISTS `shopnc_invoice` (
...
CREATE TABLE IF NOT EXISTS `shopnc_lock` (
...
INSERT INTO `shopnc_lock` (`pid`, `pvalue`, `expiretime`) VALUES
(21307064333, 1, 1421573630);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_mail_msg_temlates`
--

CREATE TABLE IF NOT EXISTS `shopnc_mail_msg_temlates` (
...
--
-- 导出表中的数据 `shopnc_mail_msg_temlates`
--

INSERT INTO `shopnc_mail_msg_temlates` (`name`, `title`, `code`, `content`, `type`, `mail_switch`) VALUES
('<strong>[给用户]</strong>用户找回密码的邮件通知', '{$site_name}提醒:{$user_name}修改密码设置', 'email_touser_find_password', '<p>尊敬的{$user_name}:</p>\r\n<p>您好, 您刚才在{$site_name}申请了重置密码，您的新密码为<span style="color:#ff9900;">{$new_password}</span>。</p>\r\n<p>请点击<a href="{$site_url}" target="_blank">{$site_url}</a>登录，修改您的新密码。</p>\r\n<p style="text-align:right;">{$site_name}</p>\r\n<p style="text-align:right;">{$mail_send_time}</p>', 0, 0);
...
--
-- 导出表中的数据 `shopnc_member`
--

INSERT INTO `shopnc_member` (`member_id`, `member_name`, `member_truename`, `member_avatar`, `member_sex`, `member_birthday`, `member_passwd`, `member_email`, `member_qq`, `member_ww`, `member_login_num`, `member_time`, `member_login_time`, `member_old_login_time`, `member_login_ip`, `member_old_login_ip`, `member_qqopenid`, `member_qqinfo`, `member_sinaopenid`, `member_sinainfo`, `member_points`, `available_predeposit`, `freeze_predeposit`, `inform_allow`, `is_buy`, `is_allowtalk`, `member_state`, `member_credit`, `member_snsvisitnum`, `member_areaid`, `member_cityid`, `member_provinceid`, `member_areainfo`, `member_privacy`) VALUES
(1, 'shopnc', '', '', 0, NULL, '804451dc13014b1c785fb73b1617b760', 'feng@shopnc.com', '', '', 7, '1387941824', '1389780374', '1389780361', '127.0.0.1', '127.0.0.1', '', '', '', '', 90, 0.00, 0.00, 1, 1, 1, 1, 0, 5, NULL, NULL, NULL, NULL, NULL),
(2, 'test', '', '', 0, NULL, 'e10adc3949ba59abbe56e057f20f883e', '2324704583@qq.com', '', NULL, 3, '1421573030', '1421573524', '1421573300', '127.0.0.1', '127.0.0.1', '', '', '', '', 20, 0.00, 0.00, 1, 1, 1, 1, 0, 0, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `shopnc_message` (
...
--
-- 表的结构 `shopnc_micro_adv`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_adv` (
...
--
-- 表的结构 `shopnc_micro_comment`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_comment` (
  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论编号',
  `comment_type` tinyint(1) NOT NULL COMMENT '评论类型编号',
  `comment_object_id` int(10) unsigned NOT NULL COMMENT '推荐商品编号',
...
--
-- 表的结构 `shopnc_micro_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_goods` (
...
--
-- 表的结构 `shopnc_micro_goods_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_goods_class` (
...
--
-- 导出表中的数据 `shopnc_micro_goods_class`
--
...
--
-- 表的结构 `shopnc_micro_goods_relation`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_goods_relation` (
  `relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '关系编号',
...
--
-- 导出表中的数据 `shopnc_micro_goods_relation`
--
...
--
-- 表的结构 `shopnc_micro_like`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_like` (
...
--
-- 表的结构 `shopnc_micro_member_info`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_member_info` (
...
--
-- 导出表中的数据 `shopnc_micro_member_info`
--
...
--
-- 表的结构 `shopnc_micro_personal`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_personal` (
...
--
-- 表的结构 `shopnc_micro_personal_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_personal_class` (
  `class_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(4) unsigned NOT NULL COMMENT '排序',
  `class_image` varchar(100) NOT NULL DEFAULT '' COMMENT '分类图片',
...
--
-- 导出表中的数据 `shopnc_micro_personal_class`
--
...
--
-- 表的结构 `shopnc_micro_store`
--

CREATE TABLE IF NOT EXISTS `shopnc_micro_store` (
...
--
-- 表的结构 `shopnc_navigation`
--

CREATE TABLE IF NOT EXISTS `shopnc_navigation` (
  ...
  PRIMARY KEY (`nav_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='页面导航表' AUTO_INCREMENT=14 ;

--
-- 导出表中的数据 `shopnc_navigation`
--

INSERT INTO `shopnc_navigation` (`nav_id`, `nav_type`, `nav_title`, `nav_url`, `nav_location`, `nav_new_open`, `nav_sort`, `item_id`) VALUES
(6, 0, '关于ShopNC', 'http://localhost/tjshop/shop/index.php?act=article&article_id=22', 2, 0, 255, 0),
(7, 0, '联系我们', 'http://localhost/tjshop/shop/index.php?act=article&article_id=23', 2, 0, 240, 0),
(8, 0, '合作及洽谈', 'http://localhost/tjshop/shop/index.php?act=article&article_id=25', 2, 0, 220, 0),
(9, 0, '招聘英才', 'http://localhost/tjshop/shop/index.php?act=article&article_id=24', 2, 0, 210, 0),
(11, 0, '门户', 'http://localhost/tjshop/cms', 1, 1, 255, 0),
(12, 0, '圈子', 'http://localhost/tjshop/circle', 1, 1, 255, 0),
(13, 0, '微商城', 'http://localhost/tjshop/microshop', 1, 1, 255, 0);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_offpay_area`
--

CREATE TABLE IF NOT EXISTS `shopnc_offpay_area` (
  `store_id` int(8) NOT NULL COMMENT '商家ID',
  `area_id` text COMMENT '县ID组合'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='货到付款支持地区表';

--
-- 导出表中的数据 `shopnc_offpay_area`
--
...
CREATE TABLE IF NOT EXISTS `shopnc_order` (
...
--
-- 导出表中的数据 `shopnc_order`
--

INSERT INTO `shopnc_order` (`order_id`, `order_sn`, `pay_sn`, `store_id`, `store_name`, `buyer_id`, `buyer_name`, `buyer_email`, `add_time`, `payment_code`, `payment_time`, `finnshed_time`, `goods_amount`, `order_amount`, `pd_amount`, `shipping_fee`, `evaluation_state`, `order_state`, `refund_state`, `lock_state`, `refund_amount`, `delay_time`, `order_from`, `shipping_code`) VALUES
(1, 7000000000000101, 290474917098197002, 1, '官方店铺', 2, 'test', '2324704583@qq.com', 1421573098, 'online', 0, 0, 899.00, 899.00, 0.00, 0.00, '0', '10', 0, 0, 0.00, 0, '1', ''),
(2, 7000000000000201, 990474917538412002, 1, '官方店铺', 2, 'test', '2324704583@qq.com', 1421573538, 'online', 0, 0, 0.02, 0.02, 0.00, 0.00, '0', '10', 0, 0, 0.00, 0, '1', ''),
(3, 7000000000000301, 620474917918760002, 1, '官方店铺', 2, 'test', '2324704583@qq.com', 1421573918, 'online', 0, 0, 0.02, 0.02, 0.00, 0.00, '0', '10', 0, 0, 0.00, 0, '1', ''),
(4, 7000000000000401, 830474918082320002, 1, '官方店铺', 2, 'test', '2324704583@qq.com', 1421574082, 'online', 0, 0, 0.02, 0.02, 0.00, 0.00, '0', '10', 0, 0, 0.00, 0, '1', '');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_order_bill`
--

CREATE TABLE IF NOT EXISTS `shopnc_order_bill` (
...
--
-- 表的结构 `shopnc_order_common`
--

CREATE TABLE IF NOT EXISTS `shopnc_order_common` (
  `order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '订单索引id',
  `store_id` int(10) unsigned NOT NULL COMMENT '店铺ID',
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表' AUTO_INCREMENT=5 ;

--
-- 导出表中的数据 `shopnc_order_common`
--

INSERT INTO `shopnc_order_common` (`order_id`, `store_id`, `shipping_time`, `shipping_express_id`, `evaluation_time`, `evalseller_state`, `evalseller_time`, `order_message`, `order_pointscount`, `voucher_price`, `voucher_code`, `deliver_explain`, `daddress_id`, `reciver_name`, `reciver_info`, `reciver_province_id`, `invoice_info`, `promotion_info`) VALUES
(1, 1, 0, 0, 0, '0', 0, '', 0, NULL, NULL, NULL, 0, '测试', 'a:2:{s:7:"address";s:41:"北京	北京市	东城区&nbsp;纬地路";s:5:"phone";s:11:"13020111648";}', 1, 'a:0:{}', ''),
(2, 1, 0, 0, 0, '0', 0, '', 0, NULL, NULL, NULL, 0, '测试', 'a:2:{s:7:"address";s:41:"北京	北京市	东城区&nbsp;纬地路";s:5:"phone";s:11:"13020111648";}', 1, 'a:0:{}', ''),
(3, 1, 0, 0, 0, '0', 0, '', 0, NULL, NULL, NULL, 0, '测试', 'a:2:{s:7:"address";s:41:"北京	北京市	东城区&nbsp;纬地路";s:5:"phone";s:11:"13020111648";}', 1, 'a:0:{}', ''),
(4, 1, 0, 0, 0, '0', 0, '', 0, NULL, NULL, NULL, 0, '测试', 'a:2:{s:7:"address";s:41:"北京	北京市	东城区&nbsp;纬地路";s:5:"phone";s:11:"13020111648";}', 1, 'a:0:{}', '');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_order_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_order_goods` (
...
--
-- 导出表中的数据 `shopnc_order_goods`
--

INSERT INTO `shopnc_order_goods` (`rec_id`, `order_id`, `goods_id`, `goods_name`, `goods_price`, `goods_num`, `goods_image`, `goods_pay_price`, `store_id`, `buyer_id`, `goods_type`, `promotions_id`, `commis_rate`) VALUES
(1, 1, 231, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口', 899.00, 1, '1_04423392298369303.jpg', 899.00, 1, 2, '1', 0, 0),
(2, 2, 233, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒', 0.02, 1, '1_04423392298369303.jpg', 0.02, 1, 2, '1', 0, 0),
(3, 3, 233, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒', 0.02, 1, '1_04423392298369303.jpg', 0.02, 1, 2, '1', 0, 0),
(4, 4, 233, '至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒', 0.02, 1, '1_04423392298369303.jpg', 0.02, 1, 2, '1', 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_order_log`
--

CREATE TABLE IF NOT EXISTS `shopnc_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单处理历史表' AUTO_INCREMENT=5 ;

--
-- 导出表中的数据 `shopnc_order_log`
--

INSERT INTO `shopnc_order_log` (`log_id`, `order_id`, `log_msg`, `log_time`, `log_role`, `log_user`, `log_orderstate`) VALUES
(1, 1, '提交了订单', 1421573098, '买家', '', '10'),
(2, 2, '提交了订单', 1421573538, '买家', '', '10'),
(3, 3, '提交了订单', 1421573918, '买家', '', '10'),
(4, 4, '提交了订单', 1421574082, '买家', '', '10');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_order_pay`
--

CREATE TABLE IF NOT EXISTS `shopnc_order_pay` (
  ...
  PRIMARY KEY (`pay_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单支付表' AUTO_INCREMENT=5 ;

--
-- 导出表中的数据 `shopnc_order_pay`
--

INSERT INTO `shopnc_order_pay` (`pay_id`, `pay_sn`, `buyer_id`, `api_pay_state`) VALUES
(1, 290474917098197002, 2, '0'),
(2, 990474917538412002, 2, '0'),
(3, 620474917918760002, 2, '0'),
(4, 830474918082320002, 2, '0');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_order_statis`
--

CREATE TABLE IF NOT EXISTS `shopnc_order_statis` (
...
CREATE TABLE IF NOT EXISTS `shopnc_payment` (
...
--
-- 导出表中的数据 `shopnc_payment`
--

INSERT INTO `shopnc_payment` (`payment_id`, `payment_code`, `payment_name`, `payment_config`, `payment_state`) VALUES
...
(3, 'tenpay', '财付通', 'a:2:{s:14:"tenpay_account";s:0:"";s:10:"tenpay_key";s:0:"";}', '1'),
(4, 'chinabank', '网银在线', 'a:2:{s:17:"chinabank_account";s:0:"";s:13:"chinabank_key";s:0:"";}', '1'),
(5, 'predeposit', '预存款', 'a:1:{s:0:"";s:0:"";}', '1'),
(6, 'wxpay', '微信支付', NULL, '1');
...
CREATE TABLE IF NOT EXISTS `shopnc_pd_cash` (
...
CREATE TABLE IF NOT EXISTS `shopnc_pd_log` (
...
--
-- 表的结构 `shopnc_pd_recharge`
--

CREATE TABLE IF NOT EXISTS `shopnc_pd_recharge` (
...
CREATE TABLE IF NOT EXISTS `shopnc_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会员积分日志表' AUTO_INCREMENT=2 ;

--
-- 导出表中的数据 `shopnc_points_log`
--

INSERT INTO `shopnc_points_log` (`pl_id`, `pl_memberid`, `pl_membername`, `pl_adminid`, `pl_adminname`, `pl_points`, `pl_addtime`, `pl_desc`, `pl_stage`) VALUES
(1, 2, 'test', NULL, NULL, 20, 1421573030, '注册会员', 'regist');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_points_order`
--
...
--
-- 表的结构 `shopnc_points_orderaddress`
--
...
--
-- 导出表中的数据 `shopnc_points_orderaddress`
--
...
--
-- 导出表中的数据 `shopnc_points_ordergoods`
--
...
--
-- 表的结构 `shopnc_p_booth_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_booth_goods` (
...
--
-- 表的结构 `shopnc_p_booth_quota`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_booth_quota` (
...
--
-- 表的结构 `shopnc_p_bundling`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_bundling` (
...
--
-- 表的结构 `shopnc_p_bundling_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_bundling_goods` (
...
--
-- 导出表中的数据 `shopnc_p_bundling_goods`
--
...
--
-- 表的结构 `shopnc_p_bundling_quota`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_bundling_quota` (
...
--
-- 导出表中的数据 `shopnc_p_bundling_quota`
--
...
--
-- 表的结构 `shopnc_p_mansong`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_mansong` (
...
--
-- 表的结构 `shopnc_p_mansong_quota`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_mansong_quota` (
...
--
-- 导出表中的数据 `shopnc_p_mansong_quota`
--
...
--
-- 表的结构 `shopnc_p_mansong_rule`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_mansong_rule` (
...
--
-- 表的结构 `shopnc_p_xianshi`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_xianshi` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='限时折扣活动表' AUTO_INCREMENT=8 ;

--
-- 导出表中的数据 `shopnc_p_xianshi`
--

INSERT INTO `shopnc_p_xianshi` (`xianshi_id`, `xianshi_name`, `xianshi_title`, `xianshi_explain`, `quota_id`, `start_time`, `end_time`, `member_id`, `store_id`, `member_name`, `store_name`, `lower_limit`, `state`) VALUES
(7, '2013年款 清仓促销', '月末折扣', '挥泪大甩卖', 5, 1389167520, 1417968000, 1, 1, 'feng', '官方店铺', 2, 1);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_p_xianshi_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_xianshi_goods` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='限时折扣商品表' AUTO_INCREMENT=27 ;

--
-- 导出表中的数据 `shopnc_p_xianshi_goods`
--

INSERT INTO `shopnc_p_xianshi_goods` (`xianshi_goods_id`, `xianshi_id`, `xianshi_name`, `xianshi_title`, `xianshi_explain`, `goods_id`, `store_id`, `goods_name`, `goods_price`, `xianshi_price`, `goods_image`, `start_time`, `end_time`, `lower_limit`, `state`, `xianshi_recommend`) VALUES
(24, 7, '2013年款 清仓促销', '月末折扣', '挥泪大甩卖', 49, 1, '春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色', 129.00, 100.00, '1_04418240955916042.jpg', 1389167520, 1417968000, 2, 1, 0),
...
--
-- 表的结构 `shopnc_p_xianshi_quota`
--

CREATE TABLE IF NOT EXISTS `shopnc_p_xianshi_quota` (
  ...
  `end_time` int(10) unsigned NOT NULL COMMENT '套餐结束时间',
  PRIMARY KEY (`quota_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='限时折扣套餐表' AUTO_INCREMENT=6 ;

--
-- 导出表中的数据 `shopnc_p_xianshi_quota`
--

INSERT INTO `shopnc_p_xianshi_quota` (`quota_id`, `member_id`, `store_id`, `member_name`, `store_name`, `start_time`, `end_time`) VALUES
(5, 1, 1, 'shopnc', '官方店铺', 1389167180, 1420271180);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_rec_position`
--

CREATE TABLE IF NOT EXISTS `shopnc_rec_position` (
...
--
-- 表的结构 `shopnc_refund_return`
--

CREATE TABLE IF NOT EXISTS `shopnc_refund_return` (
...
CREATE TABLE IF NOT EXISTS `shopnc_salenum` (
...
--
-- 导出表中的数据 `shopnc_salenum`
--

INSERT INTO `shopnc_salenum` (`date`, `salenum`, `goods_id`, `store_id`) VALUES
(20150118, 1, 231, 1),
(20150118, 3, 233, 1);
...
CREATE TABLE IF NOT EXISTS `shopnc_seller` (
...
--
-- 导出表中的数据 `shopnc_seller`
--

INSERT INTO `shopnc_seller` (`seller_id`, `seller_name`, `member_id`, `seller_group_id`, `store_id`, `is_admin`, `seller_quicklink`, `last_login_time`) VALUES
(1, 'shopnc_seller', 1, 0, 1, 1, ',store_goods_add,store_goods_online,store_goods_offline,store_order,store_deliver_set,store_groupbuy,store_promotion_xianshi', 1421573327);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_seller_group`
--

CREATE TABLE IF NOT EXISTS `shopnc_seller_group` (
...
--
-- 表的结构 `shopnc_seller_log`
--

CREATE TABLE IF NOT EXISTS `shopnc_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='卖家日志表' AUTO_INCREMENT=7 ;

--
-- 导出表中的数据 `shopnc_seller_log`
--

INSERT INTO `shopnc_seller_log` (`log_id`, `log_content`, `log_time`, `log_seller_id`, `log_seller_name`, `log_store_id`, `log_seller_ip`, `log_url`, `log_state`) VALUES
(1, '登录成功', 1421572948, 1, 'shopnc_seller', 1, '127.0.0.1', 'seller_login&login', 1),
(2, '编辑商品，平台货号：100086', 1421572982, 1, 'shopnc_seller', 1, '127.0.0.1', 'store_goods_online&edit_save_goods', 1),
(3, '登录成功', 1421573327, 1, 'shopnc_seller', 1, '127.0.0.1', 'seller_login&login', 1),
(4, '编辑商品，平台货号：100085', 1421573349, 1, 'shopnc_seller', 1, '127.0.0.1', 'store_goods_online&edit_save_goods', 1),
(5, '编辑商品，平台货号：100085', 1421573377, 1, 'shopnc_seller', 1, '127.0.0.1', 'store_goods_online&edit_save_goods', 1),
(6, '编辑商品，平台货号：100085', 1421573452, 1, 'shopnc_seller', 1, '127.0.0.1', 'store_goods_online&edit_save_goods', 1);
...
CREATE TABLE IF NOT EXISTS `shopnc_seo` (
...
INSERT INTO `shopnc_seo` (`id`, `title`, `keywords`, `description`, `type`) VALUES
...
CREATE TABLE IF NOT EXISTS `shopnc_setting` (
...
--
-- 导出表中的数据 `shopnc_setting`
--

INSERT INTO `shopnc_setting` (`name`, `value`) VALUES
...
('malbum_max_sum', '200'),
('md5_key', '7716c8446d0d1d290533d233471dd38d'),
...
--
-- 表的结构 `shopnc_sns_albumclass`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_albumclass` (
...
--
-- 导出表中的数据 `shopnc_sns_albumclass`
--

INSERT INTO `shopnc_sns_albumclass` (`ac_id`, `ac_name`, `member_id`, `ac_des`, `ac_sort`, `ac_cover`, `upload_time`, `is_default`) VALUES
(1, '买家秀', 2, '买家秀默认相册', 1, '', 1421573030, 1);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_sns_albumpic`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_albumpic` (
...
--
-- 表的结构 `shopnc_sns_binding`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_binding` (
...
--
-- 表的结构 `shopnc_sns_comment`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_comment` (
...
--
-- 表的结构 `shopnc_sns_friend`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_friend` (
...
--
-- 表的结构 `shopnc_sns_goods`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_goods` (
...
--
-- 表的结构 `shopnc_sns_membertag`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_membertag` (
...
--
-- 表的结构 `shopnc_sns_mtagmember`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_mtagmember` (
...
--
-- 表的结构 `shopnc_sns_setting`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_setting` (
  `member_id` int(11) NOT NULL COMMENT '会员id',
...
--
-- 表的结构 `shopnc_sns_sharegoods`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_sharegoods` (
...
--
-- 表的结构 `shopnc_sns_sharestore`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_sharestore` (
  `share_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
--
-- 表的结构 `shopnc_sns_tracelog`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_tracelog` (
...
--
-- 表的结构 `shopnc_sns_visitor`
--

CREATE TABLE IF NOT EXISTS `shopnc_sns_visitor` (
...
CREATE TABLE IF NOT EXISTS `shopnc_spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品规格表' AUTO_INCREMENT=16 ;

--
-- 导出表中的数据 `shopnc_spec`
--

INSERT INTO `shopnc_spec` (`sp_id`, `sp_name`, `sp_sort`, `class_id`, `class_name`) VALUES
(1, '颜色', 0, 0, ''),
(15, '尺码', 0, 0, '');
...
--
-- 表的结构 `shopnc_spec_value`
--

CREATE TABLE IF NOT EXISTS `shopnc_spec_value` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品规格值表' AUTO_INCREMENT=433 ;

--
-- 导出表中的数据 `shopnc_spec_value`
--

INSERT INTO `shopnc_spec_value` (`sp_value_id`, `sp_value_name`, `sp_id`, `gc_id`, `store_id`, `sp_value_color`, `sp_value_sort`) VALUES
...
--
-- 表的结构 `shopnc_stat_member`
--

CREATE TABLE IF NOT EXISTS `shopnc_stat_member` (
...
CREATE TABLE IF NOT EXISTS `shopnc_store` (
...
--
-- 导出表中的数据 `shopnc_store`
--

INSERT INTO `shopnc_store` (`store_id`, `store_name`, `store_auth`, `name_auth`, `grade_id`, `member_id`, `member_name`, `seller_name`, `store_owner_card`, `sc_id`, `store_company_name`, `area_id`, `area_info`, `store_address`, `store_zip`, `store_tel`, `store_image`, `store_image1`, `store_state`, `store_close_info`, `store_sort`, `store_time`, `store_end_time`, `store_label`, `store_banner`, `store_keywords`, `store_description`, `store_qq`, `store_ww`, `description`, `store_zy`, `store_domain`, `store_domain_times`, `store_recommend`, `store_theme`, `store_credit`, `praise_rate`, `store_desccredit`, `store_servicecredit`, `store_deliverycredit`, `store_collect`, `store_slide`, `store_slide_url`, `store_stamp`, `store_printdesc`, `store_sales`, `store_presales`, `store_aftersales`, `store_workingtime`, `store_free_price`, `store_storage_alarm`) VALUES
(1, '官方店铺', 0, 0, 3, 1, 'shopnc', 'shopnc_seller', '', 5, NULL, 0, '天津 天津市 红桥区', '', '', '', NULL, NULL, 1, '', 0, '1387942806', '', NULL, NULL, '', '', NULL, NULL, NULL, '', NULL, 0, 0, 'default', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0.00, 10);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_store_bind_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_bind_class` (
...
--
-- 导出表中的数据 `shopnc_store_bind_class`
--
...
--
-- 表的结构 `shopnc_store_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_class` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='店铺分类表' AUTO_INCREMENT=65 ;

--
-- 导出表中的数据 `shopnc_store_class`
--

INSERT INTO `shopnc_store_class` (`sc_id`, `sc_name`, `sc_parent_id`, `sc_sort`) VALUES
(1, '珠宝/首饰', 0, 8),
(4, '服装鞋包', 0, 1),
(5, '3C数码', 0, 2),
(6, '美容护理', 0, 3),
...
--
-- 表的结构 `shopnc_store_cost`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_cost` (
...
--
-- 表的结构 `shopnc_store_extend`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_extend` (
...
--
-- 表的结构 `shopnc_store_goods_class`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_goods_class` (
...
--
-- 导出表中的数据 `shopnc_store_goods_class`
--
...
--
-- 表的结构 `shopnc_store_grade`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_grade` (
...
--
-- 导出表中的数据 `shopnc_store_grade`
--

INSERT INTO `shopnc_store_grade` (`sg_id`, `sg_name`, `sg_goods_limit`, `sg_album_limit`, `sg_space_limit`, `sg_template_number`, `sg_template`, `sg_price`, `sg_confirm`, `sg_description`, `sg_function`, `sg_sort`) VALUES
(1, '系统默认', 100, 500, 100, 6, 'default|style1|style2|style3|style4|style5', '100元/年', 0, '用户选择“默认等级”，可以立即开通。', '', 0),
(2, '白金店铺', 200, 1000, 100, 6, 'default|style1|style2|style3|style4|style5', '200元/年', 1, '享受更多特权', 'editor_multimedia', 2),
(3, '钻石店铺', 0, 1000, 100, 6, 'default|style1|style2|style3|style4|style5', '1000', 0, '', 'editor_multimedia', 100);

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_store_joinin`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_joinin` (
  `member_id` int(10) unsigned NOT NULL COMMENT '用户编号',
...
--
-- 导出表中的数据 `shopnc_store_navigation`
--
...
--
-- 表的结构 `shopnc_store_plate`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_plate` (
...
--
-- 表的结构 `shopnc_store_sns_comment`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_sns_comment` (
...
--
-- 导出表中的数据 `shopnc_store_sns_comment`
--
...
--
-- 表的结构 `shopnc_store_sns_setting`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_sns_setting` (
...
--
-- 导出表中的数据 `shopnc_store_sns_setting`
--
...
--
-- 表的结构 `shopnc_store_sns_tracelog`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_sns_tracelog` (
...
--
-- 导出表中的数据 `shopnc_store_sns_tracelog`
--
...
--
-- 表的结构 `shopnc_store_watermark`
--

CREATE TABLE IF NOT EXISTS `shopnc_store_watermark` (
...
--
-- 导出表中的数据 `shopnc_store_watermark`
--
...
--
-- 表的结构 `shopnc_transport`
--

CREATE TABLE IF NOT EXISTS `shopnc_transport` (
...
--
-- 表的结构 `shopnc_transport_extend`
--

CREATE TABLE IF NOT EXISTS `shopnc_transport_extend` (
...
--
-- 导出表中的数据 `shopnc_transport_extend`
--
...
CREATE TABLE IF NOT EXISTS `shopnc_type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商品类型表' AUTO_INCREMENT=37 ;

--
-- 导出表中的数据 `shopnc_type`
--

INSERT INTO `shopnc_type` (`type_id`, `type_name`, `type_sort`, `class_id`, `class_name`) VALUES
...
--
-- 表的结构 `shopnc_type_brand`
--

CREATE TABLE IF NOT EXISTS `shopnc_type_brand` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `brand_id` int(10) unsigned NOT NULL COMMENT '品牌id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与品牌对应表';

--
-- 导出表中的数据 `shopnc_type_brand`
--

INSERT INTO `shopnc_type_brand` (`type_id`, `brand_id`) VALUES
(34, 101),
(34, 79),
(34, 108),
(34, 105),
...
--
-- 表的结构 `shopnc_type_spec`
--

CREATE TABLE IF NOT EXISTS `shopnc_type_spec` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `sp_id` int(10) unsigned NOT NULL COMMENT '规格id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与规格对应表';

--
-- 导出表中的数据 `shopnc_type_spec`
--

INSERT INTO `shopnc_type_spec` (`type_id`, `sp_id`) VALUES
(36, 15),
(36, 1),
(35, 15),
(35, 1),
...
CREATE TABLE IF NOT EXISTS `shopnc_upload` (
...
--
-- 表的结构 `shopnc_voucher_quota`
--

CREATE TABLE IF NOT EXISTS `shopnc_voucher_quota` (
...
--
-- 导出表中的数据 `shopnc_voucher_template`
--
...
CREATE TABLE IF NOT EXISTS `shopnc_web` (
...
INSERT INTO `shopnc_web` (`web_id`, `web_name`, `style_name`, `web_page`, `update_time`, `web_sort`, `web_show`, `web_html`) VALUES
(1, '红色', 'red', 'index', 1389864697, 1, 0, NULL),
(2, '女装/男装/内衣', 'pink', 'index', 1421573397, 1, 1, '\r\n<div class="home-standard-layout wrapper style-pink">\r\n  <div class="left-sidebar">\r\n    <div class="title">\r\n      	      	<div class="pic-type"><img src="http://localhost/tjshop/data/upload/shop/editor/web-2-21.png?920"/></div>\r\n      	    </div>\r\n    <div class="left-ads">\r\n      	      	<a href="http://shop.shopnc.v2014" title="出游服装五折起" target="_blank">\r\n      	<img src="http://localhost/tjshop/data/upload/shop/editor/web-2-23.png?543" alt="出游服装五折起">\r\n      	</a>\r\n      	    </div>\r\n    <div class="recommend-classes">\r\n      <ul>\r\n                  		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=108" title="正装鞋" target="_blank">正装鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=16" title="卫衣" target="_blank">卫衣</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=110" title="凉鞋／沙滩鞋" target="_blank">凉鞋／沙滩鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=19" title="半身裙" target="_blank">半身裙</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=24" title="西服" target="_blank">西服</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=26" title="风衣" target="_blank">风衣</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=27" title="大衣" target="_blank">大衣</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=29" title="棉服" target="_blank">棉服</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=31" title="孕妇装" target="_blank">孕妇装</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=32" title="大码装" target="_blank">大码装</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=33" title="中老年装" target="_blank">中老年装</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=107" title="商务休闲鞋" target="_blank">商务休闲鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=109" title="休闲鞋" target="_blank">休闲鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=111" title="男靴" target="_blank">男靴</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=112" title="功能鞋" target="_blank">功能鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=113" title="拖鞋" target="_blank">拖鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=114" title="传统布鞋" target="_blank">传统布鞋</a></li>\r\n		                            <li><a href="http://localhost/tjshop/shop/index.php?act=search&op=index&cate_id=116" title="帆布鞋" target="_blank">帆布鞋</a></li>\r\n		                                          </ul>\r\n    </div>\r\n  </div>\r\n  <div class="middle-layout">\r\n    <ul class="tabs-nav">\r\n                                            <li class="tabs-selected"><i class="arrow"></i><h3>冬季内衣</h3></li>\r\n                          <li class=""><i class="arrow"></i><h3>女装春款</h3></li>\r\n                                        </ul>\r\n                                                                                              <div class="tabs-panel middle-banner-style01 fade-img ">\r\n                                    <a href="" title="美腿连裤袜-美腿就要Show出来" class="a1" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-11.png?980" alt="美腿连裤袜-美腿就要Show出来"></a>\r\n                                    <a href="" title="男士内衣-冬季型男内衣装备" class="a2" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-12.png?428" alt="男士内衣-冬季型男内衣装备"></a>\r\n                                    <a href="" title="冬季保暖内衣-您准备好了吗？" class="b1" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-14.png?143" alt="冬季保暖内衣-您准备好了吗？"></a>\r\n                                    <a href="" title="可爱睡衣-冬季宅家卡哇伊" class="c1" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-21.png?789" alt="可爱睡衣-冬季宅家卡哇伊"></a>\r\n                                    <a href="" title="聚拢文胸-女神衣橱必备" class="c2" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-24.png?630" alt="聚拢文胸-女神衣橱必备"></a>\r\n                                    <a href="" title="北极绒羊毛超柔活力棉黄金甲加绒" class="d1" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-31.png?813" alt="北极绒羊毛超柔活力棉黄金甲加绒"></a>\r\n                                    <a href="" title="摇粒绒套装，休闲 时光轻松舒适！" class="d2" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-32.png?409" alt="摇粒绒套装，休闲 时光轻松舒适！"></a>\r\n                                    <a href="" title="女装 HEATTECH摇粒绒两翻领T恤" class="d3" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-33.png?697" alt="女装 HEATTECH摇粒绒两翻领T恤"></a>\r\n                                    <a href="" title="穿着温暖感受出众 HEATTECH长短袜" class="d4" target="_blank">\r\n                                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-25-1-34.png?671" alt="穿着温暖感受出众 HEATTECH长短袜"></a>\r\n                                </div>\r\n                                                                                                        <div class="tabs-panel middle-goods-list tabs-hide">\r\n                                    <ul>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=54" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 粉色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 粉色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=54">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418254218437108_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 粉色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥99.00</em>\r\n                                            <span class="original">￥483.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=53" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 紫色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 紫色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=53">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418254088878407_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 紫色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥99.00</em>\r\n                                            <span class="original">￥483.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=52" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=52">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418253240878850_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥99.00</em>\r\n                                            <span class="original">￥483.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=51" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=51">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418242684128103_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥129.00</em>\r\n                                            <span class="original">￥358.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=50" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=50">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418241398474746_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥129.00</em>\r\n                                            <span class="original">￥358.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=49" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=49">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240955916042_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥129.00</em>\r\n                                            <span class="original">￥358.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=48" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 蓝色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 蓝色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=48">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240795665638_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 蓝色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥129.00</em>\r\n                                            <span class="original">￥358.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=47" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 梅红">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 梅红</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=47">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240641767556_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 梅红" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price"><em>￥129.00</em>\r\n                                            <span class="original">￥358.00</span></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                        </ul>\r\n                                  </div>\r\n                                                                </div>\r\n  <div class="right-sidebar">\r\n    <div class="title"></div>\r\n    <div class="recommend-brand">\r\n      <ul>\r\n                                            <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=104" title="esprit" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398090828687339_sm.jpg" alt="esprit"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=103" title="ELLE HOME" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398090611386532_sm.jpg" alt="ELLE HOME"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=102" title="她他/tata" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398090459092275_sm.jpg" alt="她他/tata"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=99" title="梦特娇" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398089942879365_sm.jpg" alt="梦特娇"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=96" title="佐丹奴" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398089412399747_sm.jpg" alt="佐丹奴"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=90" title="金利来" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04397473042647991_sm.jpg" alt="金利来"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=84" title="阿迪达斯" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04397471910652190_sm.jpg" alt="阿迪达斯"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=85" title="猫人" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04397472152849925_sm.jpg" alt="猫人"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=79" title="justyle" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04397468710494742_sm.jpg" alt="justyle"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=116" title="Dior" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398099738566948_sm.jpg" alt="Dior"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=100" title="宝姿" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398090061006740_sm.jpg" alt="宝姿"></a>\r\n        </li>\r\n                          <li>\r\n          <a href="http://localhost/tjshop/shop/index.php?act=brand&op=list&brand=95" title="李宁" target="_blank">\r\n          	<img src="http://localhost/tjshop/data/upload/shop/brand/04398089270610035_sm.jpg" alt="李宁"></a>\r\n        </li>\r\n                                          </ul>\r\n    </div>\r\n    <div class="right-side-focus">\r\n      <ul>\r\n                                                                                <li><a href="" title="" target="_blank">\r\n                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-28-1.jpg?603" alt=""/></a>\r\n                      	</li>\r\n                                                                                    <li><a href="" title="" target="_blank">\r\n                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-28-2.jpg?121" alt=""/></a>\r\n                      	</li>\r\n                                                                                    <li><a href="" title="" target="_blank">\r\n                        <img src="http://localhost/tjshop/data/upload/shop/editor/web-2-28-3.jpg?841" alt=""/></a>\r\n                      	</li>\r\n                                                                </ul>\r\n    </div>\r\n  </div>\r\n</div>'),
...
(101, '首页头部焦点图片', 'orange', 'index_pic', 1421573397, 100, 1, '\r\n  <ul id="fullScreenSlides" class="full-screen-slides">\r\n                                        <li style="background: #2D080F url(''http://localhost/tjshop/data/upload/shop/editor/web-101-101-1.jpg?454'') no-repeat center top">\r\n            <a href="" target="_blank" title="冬季名品-大牌季节日">&nbsp;</a></li>\r\n                                        <li style="background: #F6BB3D url(''http://localhost/tjshop/data/upload/shop/editor/web-101-101-5.jpg?166'') no-repeat center top">\r\n            <a href="" target="_blank" title="全套茶具专场-年终盛典">&nbsp;</a></li>\r\n                                        <li style="background: #36142C url(''http://localhost/tjshop/data/upload/shop/editor/web-101-101-2.jpg?331'') no-repeat center top">\r\n            <a href="" target="_blank" title="女人再忙也要留一天为自己疯抢">&nbsp;</a></li>\r\n                                        <li style="background: #f2f2f2 url(''http://localhost/tjshop/data/upload/shop/editor/web-101-101-3.jpg?249'') no-repeat center top">\r\n            <a href="" target="_blank" title="全年爆款-年底清仓">&nbsp;</a></li>\r\n                                        <li style="background: #ECBCB0 url(''http://localhost/tjshop/data/upload/shop/editor/web-101-101-4.jpg?250'') no-repeat center top">\r\n            <a href="" target="_blank" title="清仓年末特优-满99元包邮">&nbsp;</a></li>\r\n                                  \r\n  </ul>\r\n  <div class="jfocus-trigeminy">\r\n    <ul>\r\n                              <li>\r\n                                        <a href="" target="_blank" title="佳节大献礼-茶满中秋"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-1-1.jpg?842" alt="佳节大献礼-茶满中秋"></a>\r\n                          <a href="" target="_blank" title="孩子喜欢-遥控悍马"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-1-2.jpg?143" alt="孩子喜欢-遥控悍马"></a>\r\n                          <a href="" target="_blank" title="天气凉了-情侣家居服"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-1-3.jpg?114" alt="天气凉了-情侣家居服"></a>\r\n                                      </li>\r\n                    <li>\r\n                                        <a href="" target="_blank" title="越中国越时尚-水晶中国风"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-2-1.jpg?824" alt="越中国越时尚-水晶中国风"></a>\r\n                          <a href="" target="_blank" title="领先全球首创-CoolTec冰爽剃须"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-2-2.jpg?851" alt="领先全球首创-CoolTec冰爽剃须"></a>\r\n                          <a href="" target="_blank" title="健康中的专家-欧姆龙血压计"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-2-3.jpg?734" alt="健康中的专家-欧姆龙血压计"></a>\r\n                                      </li>\r\n                    <li>\r\n                                        <a href="" target="_blank" title="TOPTO秋季格调-衬衫促销季"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-3-1.jpg?191" alt="TOPTO秋季格调-衬衫促销季"></a>\r\n                          <a href="" target="_blank" title="骆驼早秋新品尝试-热销款推荐"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-3-2.jpg?628" alt="骆驼早秋新品尝试-热销款推荐"></a>\r\n                          <a href="" target="_blank" title="识得女人香-冰希利娇真我系列"><img src="http://localhost/tjshop/data/upload/shop/editor/web-101-102-3-3.jpg?851" alt="识得女人香-冰希利娇真我系列"></a>\r\n                                      </li>\r\n                        </ul>\r\n  </div>');
INSERT INTO `shopnc_web` (`web_id`, `web_name`, `style_name`, `web_page`, `update_time`, `web_sort`, `web_show`, `web_html`) VALUES
(121, '首页促销区', 'orange', 'index_sale', 1421573397, 120, 1, '\r\n    <ul class="tabs-nav">\r\n                                            <li class="tabs-selected"><i class="arrow"></i><h3>热卖商品</h3></li>\r\n                          <li class=""><i class="arrow"></i><h3>疯狂抢购</h3></li>\r\n                          <li class=""><i class="arrow"></i><h3>猜您喜欢</h3></li>\r\n                          <li class=""><i class="arrow"></i><h3>热评商品</h3></li>\r\n                          <li class=""><i class="arrow"></i><h3>新品上架</h3></li>\r\n                                        </ul>\r\n                                                                                                <div class="tabs-panel sale-goods-list ">\r\n                                    <ul>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=231" title="至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口">\r\n                                          	至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=231">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04423392298369303_240.jpg" alt="至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥899.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=232" title="中华老字号 东阿阿胶桃花姬阿胶糕300g">\r\n                                          	中华老字号 东阿阿胶桃花姬阿胶糕300g</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=232">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04423411880302392_240.png" alt="中华老字号 东阿阿胶桃花姬阿胶糕300g" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥150.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=53" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 紫色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 紫色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=53">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418254088878407_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 紫色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥99.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=49" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=49">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240955916042_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 黑色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=48" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 蓝色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 蓝色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=48">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240795665638_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 蓝色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                        </ul>\r\n                                  </div>\r\n                                                                                                        <div class="tabs-panel sale-goods-list tabs-hide">\r\n                                    <ul>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=54" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 粉色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 粉色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=54">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418254218437108_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 粉色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥99.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=52" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=52">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418253240878850_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥99.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=51" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=51">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418242684128103_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=50" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=50">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418241398474746_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=47" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 梅红">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 梅红</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=47">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240641767556_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 梅红" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                        </ul>\r\n                                  </div>\r\n                                                                                                        <div class="tabs-panel sale-goods-list tabs-hide">\r\n                                    <ul>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=46" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 绿色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 绿色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=46">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240378724556_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 绿色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=44" title="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 橙色">\r\n                                          	2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 橙色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=44">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418211855225368_240.jpg" alt="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 橙色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥179.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=43" title="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 绿色">\r\n                                          	2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 绿色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=43">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418211211965600_240.jpg" alt="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 绿色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥179.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=42" title="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 蓝色">\r\n                                          	2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 蓝色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=42">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418211646104580_240.jpg" alt="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 蓝色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥179.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=41" title="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 黑色">\r\n                                          	正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 黑色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=41">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418207748921454_240.jpg" alt="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 黑色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥189.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                        </ul>\r\n                                  </div>\r\n                                                                                                        <div class="tabs-panel sale-goods-list tabs-hide">\r\n                                    <ul>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=40" title="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 梅红">\r\n                                          	正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 梅红</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=40">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418207471410641_240.jpg" alt="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 梅红" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥189.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=39" title="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 绿色">\r\n                                          	正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 绿色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=39">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418206625430066_240.jpg" alt="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 绿色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥189.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=38" title="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 蓝色">\r\n                                          	正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 蓝色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=38">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418207207476705_240.jpg" alt="正品 2014春装新款 女 绣花针织衫 开衫外套浮桑初 蓝色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥189.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=231" title="至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口">\r\n                                          	至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=231">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04423392298369303_240.jpg" alt="至尊金奖 法国原瓶进口AOC红酒 任选一箱 红沙城堡红葡萄酒 原装进口" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥899.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=232" title="中华老字号 东阿阿胶桃花姬阿胶糕300g">\r\n                                          	中华老字号 东阿阿胶桃花姬阿胶糕300g</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=232">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04423411880302392_240.png" alt="中华老字号 东阿阿胶桃花姬阿胶糕300g" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥150.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                        </ul>\r\n                                  </div>\r\n                                                                                                        <div class="tabs-panel sale-goods-list tabs-hide">\r\n                                    <ul>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=46" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 绿色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 绿色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=46">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418240378724556_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 绿色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=44" title="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 橙色">\r\n                                          	2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 橙色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=44">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418211855225368_240.jpg" alt="2014春款打底毛衫拼色毛衣 长袖套头针织衫 莺 橙色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥179.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=50" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=50">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418241398474746_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 橙色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=51" title="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色">\r\n                                          	春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=51">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418242684128103_240.jpg" alt="春装 披肩式 超短款 针织 衫开衫 女装 青鸟 灰色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥129.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                          <li>\r\n                                        <dl>\r\n                                          <dt class="goods-name"><a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=52" title="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色">\r\n                                          	新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色</a></dt>\r\n                                          <dd class="goods-thumb">\r\n                                          	<a target="_blank" href="http://localhost/tjshop/shop/index.php?act=goods&op=index&goods_id=52">\r\n                                          	<img src="http://localhost/tjshop/data/upload/shop/store/goods/1/1_04418253240878850_240.jpg" alt="新款 女款 拼接 不规则摆 长袖针织衫开衫 杏雨 白色" />\r\n                                          	</a></dd>\r\n                                          <dd class="goods-price">商城价：<em>￥99.00</em></dd>\r\n                                        </dl>\r\n                                      </li>\r\n                                                                        </ul>\r\n                                  </div>\r\n                                                              ');

-- --------------------------------------------------------

--
-- 表的结构 `shopnc_web_code`
--

CREATE TABLE IF NOT EXISTS `shopnc_web_code` (
  ...
  PRIMARY KEY (`code_id`),
  KEY `web_id` (`web_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='模块内容表' AUTO_INCREMENT=122 ;

--
-- 导出表中的数据 `shopnc_web_code`
--

INSERT INTO `shopnc_web_code` (`code_id`, `web_id`, `code_type`, `var_name`, `code_info`, `show_name`) VALUES
(11, 1, 'array', 'tit', '', '标题图片'),
