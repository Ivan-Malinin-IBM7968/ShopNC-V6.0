...
class WxPayConf_pub
{
	...
	const APPID = 'wxa9bd7bef74d8a0c3';
	//受理商ID，身份标识
	const MCHID = '1225560002';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = 'e142e76320f20a2409a62f174df15fce';
	...
	const NOTIFY_URL = 'http://www.ddjqr.com/shop/api/payment/wxpay/notify_url.php';
